...
| `ise_policy__shell_profiles_cmdsets_enabled` | `true` | No | Feature Configuration |
...
| `ise_policy__shell_profiles_cmdsets_log_level` | `"INFO"` | No | Logging |
| `ise_policy__shell_profiles_cmdsets_log_to_syslog` | `true` | No | — |
| `ise_policy__shell_profiles_cmdsets_syslog_server` | `"{{ vault_syslog_server }}"` | No | — |
| `ise_policy__shell_profiles_cmdsets_notify_on_completion` | `false` | No | Notification Settings |
| `ise_policy__shell_profiles_cmdsets_notification_email` | `"{{ vault_security_team_email }}"` | No | — |
| `ise_policy__shell_profiles_cmdsets_auto_backup` | `true` | No | Backup Settings |
