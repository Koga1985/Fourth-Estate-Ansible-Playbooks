...
This directory contains **46 Ansible roles** for managing **Microsoft Azure** infrastructure with emphasis on security, compliance (FedRAMP, NIST 800-53), Azure Government Cloud, and Fourth Estate requirements.
